...
<div class="mdk-header-layout__content page-content ">
        ...
        <div
            ...
            <div class="flex d-flex flex-column flex-sm-row align-items-center">
                <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                    <h2 class="mb-0">New Institution</h2>
    ...
    <div class="page-section container page__container">
            ...
            {!! Form::open(array('route' => 'admin.institutions.store', 'files' => true, 'method'=>'POST', 'files' => true)) !!}
...
<script>
	...
	$(function() {
        ...
        $('select[name="timezone"]').val('{{ \Carbon\Carbon::now()->timezoneName }}').change();
        		...
        		success: function(res)
        		{
        			if(res.success) {
        				swal({
	                        ...
	                        text: "Click confirm button to confirm institution",
	                        type: 'success',
	                        ...
	                        if (val) {
	                            var url = '/admin/institutions/' + res.id + '/edit';
