        ...
        <div class="card dashboard-area-tabs p-relative o-hidden mb-lg-32pt">
            ...
            <div class="card-header p-0 nav">
                <div id="tbl_selector" class="row no-gutters" role="tablist">
                    <div class="col-auto">
                        <a href="{{ route('admin.student.getLiveSessionsByAjax', 'all') }}" data-toggle="tab" role="tab" aria-selected="true"
                    ...
                    <div class="col-auto border-left border-right">
                        <a href="{{ route('admin.student.getLiveSessionsByAjax', 'today') }}" data-toggle="tab" role="tab"
